 ...
 */
@Transactional
public interface FurnitureShopApiService {
     ...
     */
    int updateAuthenticationMessage(JSONObject json);
     ...
     */
    int updateShopBaseMessage(JSONObject json);
     ...
     * @功能描述 家弱公用：获取城列表
     */
    List<Map<String, Object>> listCity(JSONObject json);
     ...
     */
    int updateShopCityMessage(JSONObject json);
     ...
     */
    List<Map<Object, Object>> getShopCityMessage(JSONObject json);
     ...
     */
    List<Map<String, Object>> listShopTemplateByCityId(JSONObject json);
     ...
     */
    int updateShopFinanceMessage(JSONObject json);
     ...
     */
    List<Map<String, Object>> listProductAndSubjectInfoByShopType(JSONObject json);
     ...
     */
    List<Map<String, Object>> listProductAndSubjectInfoByShopIdAndShopType(JSONObject json);
     ...
     */
    List<Map<String, Object>> listProductAndSubjectInfoByCategoryCode(JSONObject json);
     ...
     */
    Map<String, Object> getProductInfo(JSONObject json);
     ...
     */
    int updateShopTypeAndProduct(JSONObject json);
     ...
     */
    List<Map<String, Object>> listShopProductByShopIdAndCategoryCode(JSONObject json);
     ...
     * @功能描述 家具店铺：新增店铺壳子
     */
    int addShopShell(List<Map<String, Object>> params);
     ...
     * @功能描述 家具店铺：根据产品编码查询产品详情
     */
    Map<String, Object> getProductInfoFromProductFurniture(JSONObject json);
     ...
     */
    Map<String, Object> getShopTeamMessage(Map<String, Object> params);
