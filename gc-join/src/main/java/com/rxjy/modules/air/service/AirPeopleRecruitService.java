...
*@Date  2019年3月12日
*/
public interface AirPeopleRecruitService extends IService<AirPeopleEntity> {
     ...
     */
    R getPeopleBasisInfo(Integer userID);
     ...
     */
    R updatePeopleBasisInfo(AirPeopleEntity airPeopleEntity);

    /**
     * 修改用户地区信息
     * @return
     */
    R updateUserRegion(AirPeopleEntity airPeopleEntity);
     ...
     * @return
     */
    R updatePeopleExp(AirPeopleEntity airPeopleEntity);
     ...
     * @return
     */
    R updatePeopleStrength(AirPeopleEntity airPeopleEntity);
     ...
     * @return
     */
    R updatePeopleSource(AirPeopleEntity airPeopleEntity);
     ...
     * @return
     */
    int insertAirPeopleInfo( List<AirPeopleInfoEntity> airPeopleInfoEntities);
     ...
     * @param joinMoney 加盟费
     * @param moneyType 金额类型 1.加盟费 2风险金
     * @return
     */
    int synchroAirPeopleJoinMoney(String sourceCode, double joinMoney,int moneyType);
}
